...
public class SlotPulverizerOutput extends Slot {
    ...
    public SlotPulverizerOutput(EntityPlayer player, IInventory inventoryIn, int slotIndex, int xPosition, int yPosition)
    {
    ...
    protected void onCrafting(ItemStack stack)
    {
        ...
        if (!this.thePlayer.worldObj.isRemote)
        {
            ...
            float f = RecipePulverizer.instance().getPulverizingExperience(stack);
